...
- **Linux**  
  ...
  - Widely used in servers and development environments  
...
Example: Hosting websites, handling requests, storing data.

---

### Open Source
Open-source software is software whose source code is publicly available.  
It is maintained and improved by a community of developers rather than a single owner.
